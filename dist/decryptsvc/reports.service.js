...
let ReportsService = class ReportsService {
    ...
    createEstimate({ year, family, hash, type, region, lng, lat, ip }) {
        return this.repo.createQueryBuilder()
            .select(['lng', 'lat', '((lng - :lng) * (lng - :lng) + (lat - :lat) * (lat - :lat)) AS distance'])
...
ReportsService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(decrypt_entity_1.Report)),
