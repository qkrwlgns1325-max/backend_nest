...
export declare class ReportsController {
    ...
    findApproved(): Promise<import("./report.entity").Report[]>;
    findAllByUserId(userId: string): Promise<import("./report.entity").Report[]>;
    findApprovedById(id: string): Promise<import("./report.entity").Report>;
