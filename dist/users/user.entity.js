...
const decrypt_entity_1 = require("../decryptsvc/decrypt.entity");
let User = class User {
    logInsert() {
...
__decorate([
    typeorm_1.OneToMany(() => decrypt_entity_1.Decrypt, (decrypt) => decrypt.user),
    __metadata("design:type", Array)
], User.prototype, "decrypts", void 0);
__decorate([
